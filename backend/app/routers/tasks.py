...
from app.repositories import project_repository, task_repository, comment_repository
...
async def update_task(
    ...
    return await task_repository.save(db, updated)
...
async def create_comment(
    ...
    await _get_project_or_404(db, project_id, user.id)
    await _get_task_or_404(db, task_id, project_id)
    return await comment_repository.create(db, task_id, user.id, payload.body)
